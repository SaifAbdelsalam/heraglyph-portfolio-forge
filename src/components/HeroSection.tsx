...
const HeroSection = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden bg-heraglyph-black">
      ...
      <div className="section-container w-full relative z-10 pt-32 md:pt-40 h-screen flex items-end md:items-center">
        {/* Text Content */}
        <div className="max-w-[1280px] w-full hero-mobile-fix md:my-auto">
          ...
          <div className={`transition-all duration-700 ${showSubheadline ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"} mb-8 hero-mobile-text hidden md:block`}>
            <p className="text-heraglyph-gray text-base md:text-lg mb-6">
              Reduce costs and increase profit with AI that removes manual work, speeds up delivery, and helps you make smarter decisions. We integrate automation into your daily workflows so you grow faster while spending less.
            </p>
          </div>
